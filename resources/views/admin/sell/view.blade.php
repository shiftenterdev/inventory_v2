        ...
        <div class="cN" id="printDiv">
            <fieldset>
                ...
                <div class="customer-info">
                    <table>
                        <tr><td>Name </td><td> : <strong>{{$result->customer->customer_name}}</strong></td></tr>
                        <tr><td>Address </td><td> : <strong>{{$result->customer->customer_address}}</strong></td></tr>
                        <tr><td>Email </td><td> : <strong>{{$result->customer->customer_email}}</strong></td></tr>
                        <tr><td>Mobile </td><td> : <strong>{{$result->customer->customer_phone}}</strong></td></tr>
                        <tr><td>Date </td><td> : <strong>{{date('d F, Y',strtotime($result->updated_at))}}</strong></td></tr>
                    </table>
                </div>
                <hr>
                <?php $total = 0; ?>
