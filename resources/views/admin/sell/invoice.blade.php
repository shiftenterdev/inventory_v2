...
<div class="col-md-9 mB">
  ...
  <div class="cN">
    ...
    <table>
      <tr>
        <td><strong>Name</strong> </td><td>: {{$customer->customer_name}}</td> </tr>
        <tr>
        <td><strong>Address</strong> </td><td>: {{$customer->customer_address}}</td>
        </tr>
        <tr>
        <td><strong>Phone</strong> </td><td>: {{$customer->customer_phone}}</td>
      </tr>
    </table>
    <br>
